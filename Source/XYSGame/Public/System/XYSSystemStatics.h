...
#include "XYSSystemStatics.generated.h"

/**
 * 
 */
UCLASS()
class XYSGAME_API UXYSSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="XYS", meta = (WorldContext = "WorldContextObject"))
