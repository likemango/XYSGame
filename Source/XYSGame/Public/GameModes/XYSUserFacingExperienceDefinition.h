...
#include "XYSUserFacingExperienceDefinition.generated.h"
...
class XYSGAME_API UXYSUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="XYSExperienceDefinition"))
