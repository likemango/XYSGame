...
class UXYSExperienceManagerComponent;
/**
 * 
 */
UCLASS(Config = Game)
class XYSGAME_API AXYSGameState : public AModularGameStateBase, public IAbilitySystemInterface
{
	GENERATED_BODY()

public:
	AXYSGameState(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	...
	UPROPERTY()
	TObjectPtr<UXYSExperienceManagerComponent> ExperienceManagerComponent;

	// The ability system component subobject for game-wide things (primarily gameplay cues)
	UPROPERTY(VisibleAnywhere, Category = "XYS|GameState")
