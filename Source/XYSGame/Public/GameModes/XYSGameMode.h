 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnXYSGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
public:
	AXYSGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "XYS|Pawn")
	const UXYSPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnXYSGameModePlayerInitialized OnGameModePlayerInitialized;
