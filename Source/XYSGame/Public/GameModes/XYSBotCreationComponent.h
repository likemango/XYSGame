...
#include "XYSBotCreationComponent.generated.h"

class UXYSExperienceDefinition;
class AAIController;

UCLASS(Blueprintable, Abstract)
class XYSGAME_API UXYSBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UXYSBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
