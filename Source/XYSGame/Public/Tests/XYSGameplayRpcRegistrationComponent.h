...
#include "XYSGameplayRpcRegistrationComponent.generated.h"

/**
 * 
 */
UCLASS()
class XYSGAME_API UXYSGameplayRpcRegistrationComponent : public UExternalRpcRegistrationComponent
{
	GENERATED_BODY()
protected:
	static  UXYSGameplayRpcRegistrationComponent* ObjectInstance;

public:
	static  UXYSGameplayRpcRegistrationComponent* GetInstance();
