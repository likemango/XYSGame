...
class XYSGAME_API UXYSControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()

public:
	UXYSControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
