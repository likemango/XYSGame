...
#include "XYSGameplayAbility_RangedWeapon.generated.h"

enum ECollisionChannel : int;

class APawn;
class UXYSRangedWeaponInstance;
class UObject;
...
UENUM(BlueprintType)
enum class EXYSAbilityTargetingSource : uint8
{
...
/**
 * UXYSGameplayAbility_RangedWeapon
 *
 * An ability granted by and associated with a ranged weapon instance
 */
UCLASS()
class XYSGAME_API UXYSGameplayAbility_RangedWeapon : public UXYSGameplayAbility_FromEquipment
{
	GENERATED_BODY()

public:

	UXYSGameplayAbility_RangedWeapon(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	struct FRangedWeaponFiringInput
	{
		...
		UXYSRangedWeaponInstance* WeaponData = nullptr;
...
protected:
	...
	FTransform GetTargetingTransform(APawn* SourcePawn, EXYSAbilityTargetingSource Source) const;
