...
#include "XYSWeaponInstance.generated.h"
 ...
 */
UCLASS()
class XYSGAME_API UXYSWeaponInstance : public UXYSEquipmentInstance
{
	GENERATED_BODY()

public:
	UXYSWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
