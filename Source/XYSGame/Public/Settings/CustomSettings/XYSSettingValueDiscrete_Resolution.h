...
#include "XYSSettingValueDiscrete_Resolution.generated.h"

/**
 * 
 */
UCLASS()
class XYSGAME_API UXYSSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UXYSSettingValueDiscrete_Resolution();
