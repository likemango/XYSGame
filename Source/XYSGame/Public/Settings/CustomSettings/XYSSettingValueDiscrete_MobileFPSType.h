...
#include "XYSSettingValueDiscrete_MobileFPSType.generated.h"

/**
 * 
 */
UCLASS()
class XYSGAME_API UXYSSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
...
public:
	...
	UXYSSettingValueDiscrete_MobileFPSType();
