...
#include "XYSPenetrationAvoidanceFeeler.generated.h"
/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FXYSPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FXYSPenetrationAvoidanceFeeler()
	...
	FXYSPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
