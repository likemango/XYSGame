...
class XYSGAME_API UGameFeatureAction_AddInputBinding : public UGameFeatureAction_WorldActionBase
{
	GENERATED_BODY()
...
public:
	...
	TArray<TSoftObjectPtr<const UXYSInputConfig>> InputConfigs;
