...
#include "XYSReplaySubsystem.generated.h"
...
class UXYSReplayListEntry : public UObject
{
	GENERATED_BODY()
...
class UXYSReplayList : public UObject
{
	GENERATED_BODY()

public:
	UPROPERTY(BlueprintReadWrite, Category=Replays)
	TArray<TObjectPtr<UXYSReplayListEntry>> Results;
};
 ...
 */
UCLASS()
class XYSGAME_API UXYSReplaySubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	void PlayReplay(UXYSReplayListEntry* Replay);
