...
#include "XYSHealthSet.generated.h"
 ...
 */
UCLASS()
class XYSGAME_API UXYSHealthSet : public UXYSAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UXYSHealthSet, MaxHealth);
	ATTRIBUTE_ACCESSORS(UXYSHealthSet, Healing);
	ATTRIBUTE_ACCESSORS(UXYSHealthSet, Damage);
