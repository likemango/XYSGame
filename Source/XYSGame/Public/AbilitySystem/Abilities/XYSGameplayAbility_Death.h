...
#include "XYSGameplayAbility_Death.generated.h"
...
/**
 * UXYSGameplayAbility_Death
 *
 *	Gameplay ability used for handling death.
 *	Ability is activated automatically via the "GameplayEvent.Death" ability trigger tag.
 */
UCLASS(Abstract)
class UXYSGameplayAbility_Death : public UXYSGameplayAbility
{
	GENERATED_BODY()

public:

	UXYSGameplayAbility_Death(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "XYS|Death")
