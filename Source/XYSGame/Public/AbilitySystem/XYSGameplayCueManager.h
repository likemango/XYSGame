...
#include "XYSGameplayCueManager.generated.h"

/**
 *  Game-specific manager for gameplay cues
 */
UCLASS()
class XYSGAME_API UXYSGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UXYSGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UXYSGameplayCueManager* Get();
