...
#include "XYSAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FXYSAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class XYSGAME_API UXYSAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()

	/** The list of relationships between different gameplay tags (which ones block or cancel others) */
	UPROPERTY(EditAnywhere, Category = Ability, meta=(TitleProperty="AbilityTag"))
	TArray<FXYSAbilityTagRelationship> AbilityTagRelationships;
