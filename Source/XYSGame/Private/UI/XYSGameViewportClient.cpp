...
#include "UI/XYSGameViewportClient.h"
...
UXYSGameViewportClient::UXYSGameViewportClient()
	:Super(FObjectInitializer::Get())
{
}

void UXYSGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance,
