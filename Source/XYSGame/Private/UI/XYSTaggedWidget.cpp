...
#include "UI/XYSTaggedWidget.h"

// Framework support widget hidden by tag.
//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UXYSTaggedWidget::UXYSTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UXYSTaggedWidget::NativeConstruct()
{
...
void UXYSTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UXYSTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UXYSTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
