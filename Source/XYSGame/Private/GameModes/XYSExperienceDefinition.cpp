...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XYSExperienceDefinition)

#define LOCTEXT_NAMESPACE "XYSSystem"

UXYSExperienceDefinition::UXYSExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UXYSExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UXYSExperienceDefinition::UpdateAssetBundleData()
{
