...
int32 UXYSHotfixManager::GameHotfixCounter = 0;

UXYSHotfixManager::UXYSHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UXYSHotfixManager::GetOnScreenMessages);
...
void UXYSHotfixManager::Init()
{
	Super::Init();
}

void UXYSHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
...
bool UXYSHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UXYSHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UXYSHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UXYSHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UXYSHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UXYSHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UXYSHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UXYSHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UXYSHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
