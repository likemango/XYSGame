...
APlayerState* UXYSVerbMessageHelper::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UXYSVerbMessageHelper::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UXYSVerbMessageHelper::VerbMessageToCueParameters(const FXYSVerbMessage& Message)
{
...
FXYSVerbMessage UXYSVerbMessageHelper::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FXYSVerbMessage Result;
