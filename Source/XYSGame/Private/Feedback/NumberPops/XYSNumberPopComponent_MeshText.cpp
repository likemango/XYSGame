...
#include "Feedback/NumberPops/XYSNumberPopComponent_MeshText.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XYSNumberPopComponent_MeshText)

class UStaticMesh;

UXYSNumberPopComponent_MeshText::UXYSNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UXYSNumberPopComponent_MeshText::AddNumberPop(const FXYSNumberPopRequest& NewRequest)
{
...
void UXYSNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UXYSNumberPopComponent_MeshText::DetermineColor(const FXYSNumberPopRequest& Request) const
{
	for (UXYSDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UXYSNumberPopComponent_MeshText::DetermineStaticMesh(const FXYSNumberPopRequest& Request) const
{
	for (UXYSDamagePopStyle* Style : Styles)
	{
...
void UXYSNumberPopComponent_MeshText::SetMaterialParameters(const FXYSNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
