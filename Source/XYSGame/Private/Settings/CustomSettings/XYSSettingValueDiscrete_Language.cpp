...
#include "Settings/CustomSettings/XYSSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XYSSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "XYS"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UXYSSettingValueDiscrete_Language::UXYSSettingValueDiscrete_Language()
{
}

void UXYSSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UXYSSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UXYSSettingValueDiscrete_Language::OnApply()
{
...
void UXYSSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UXYSSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UXYSSettingsShared* Settings = CastChecked<UXYSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UXYSSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UXYSSettingsShared* Settings = CastChecked<UXYSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UXYSSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UXYSSettingsShared* Settings = CastChecked<UXYSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UXYSSettingValueDiscrete_Language::GetDiscreteOptions() const
{
