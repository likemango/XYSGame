...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XYSSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "XYSSettings"

UXYSSettingValueDiscrete_Resolution::UXYSSettingValueDiscrete_Resolution()
{
}

void UXYSSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UXYSSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UXYSSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UXYSSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UXYSSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UXYSSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UXYSSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UXYSSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UXYSSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UXYSSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UXYSSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UXYSSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UXYSSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UXYSSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UXYSSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UXYSSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
