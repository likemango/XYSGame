...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XYSSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "XYSSettings"

UXYSSettingValueDiscrete_OverallQuality::UXYSSettingValueDiscrete_OverallQuality()
{
}

void UXYSSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	UXYSSettingsLocal* UserSettings = UXYSSettingsLocal::Get();
...
void UXYSSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UXYSSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UXYSSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UXYSSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UXYSSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UXYSSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UXYSSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UXYSSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
