...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("XYS.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!UXYSSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!UXYSSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
			InOutEditState.Disable(LOCTEXT("PlatformDoesNotSupportLatencyMarkers", "Latency markers are not supported on this device"));
		}

		// XYS is only going to use the "Reflex" plugin to track these latency stats, so restrict these settings to NVIDIA devices. 
...
void UXYSGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UXYSLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EXYSDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::ClientFPS);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::ServerFPS);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::FrameTime);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::IdleTime);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::Ping);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(UXYSSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::Latency_Total);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::Latency_Game);
			...
			{
				UXYSSettingValueDiscrete_PerfStat* Setting = NewObject<UXYSSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EXYSDisplayablePerformanceStat::Latency_Render);
