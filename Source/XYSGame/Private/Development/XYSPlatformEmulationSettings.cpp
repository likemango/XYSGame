...
UXYSPlatformEmulationSettings::UXYSPlatformEmulationSettings()
{
}

FName UXYSPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UXYSPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UXYSPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UXYSPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UXYSPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UXYSPlatformEmulationSettings::PostInitProperties()
{
...
void UXYSPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UXYSPlatformEmulationSettings::ApplySettings()
{
...
void UXYSPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UXYSPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UXYSPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UXYSPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
